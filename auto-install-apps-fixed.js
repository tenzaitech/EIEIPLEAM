...
async function autoInstallAppsFixed() {
  console.log('🤖 Auto-installing required Odoo apps for TENZAI Purchasing System (Fixed Version)...');
  ...
  try {
    ...
    const installableApps = appsToInstallFiltered
